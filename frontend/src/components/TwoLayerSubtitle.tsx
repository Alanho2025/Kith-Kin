import type { TranslationSegmentView } from "../features/conversation/viewModels";
...
export function TwoLayerSubtitle({ partialEnglish, chineseSegments }: TwoLayerSubtitleProps) {
  return (
